...
mean=0.0
weight=5
savedir=models/v005/temp2_${ntype}_${nway}_${mean}_${weight}_${batch_size}_${minibatch_split}/
...
# qsub -cwd -j yes -o 'LOGs/v005/temp_adv_add_10.log' -P esol -l hostname='*' -l qp=cuda-low -l gpuclass='*' -l osrel='*' train.sh 1 1