...
alpha=1000000
# decay=1
savedir=models/v008/${ntype}_${nway}_${mean}_${weight}_${batch_size}_${minibatch_split}_v1/

# ===================================================================================
$PYTHONBIN /home/alta/BLTSpeaking/exp-yw575/GEC/NoiseGram/trainv1.py \
...
# qsub -cwd -j yes -o 'LOGs/v008/trainv1.log' -P esol -l hostname='*' -l qp=cuda-low -l gpuclass='volta' -l osrel='*' train.sh 1 1