...
fname=checkpoints
mode='combine'
for exp in Gaussian-adversarial_mul_1.0_0.001_16_1_002
do
combine_path=$model/$exp/checkpoints/
outdir=$model/$exp/checkpoints/combine/
$PYTHONBIN /home/alta/BLTSpeaking/exp-yw575/GEC/NoiseGram/translate.py \
        --test_path_src $ftst \
        --test_path_out $outdir \
        --max_tgt_len $max_tgt_len \
...
# for exp in Gaussian-adversarial_mul_1.0_0.001_16_1_002  Gaussian-adversarial_mul_1.0_1_16_1_002 Gaussian-adversarial_mul_1.0_0.01_16_1_002 Gaussian-adversarial_mul_1.0_0.1_16_1_002
# do
# combine_path=$model/$exp/checkpoints/
# outdir=$model/$exp/checkpoints/combine/
# $PYTHONBIN /home/alta/BLTSpeaking/exp-yw575/GEC/NoiseGram/translate.py \
