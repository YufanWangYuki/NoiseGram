...
class Trainer(object):
	...
	def _train_epochs(self,
		...
		outdir="/home/alta/BLTSpeaking/exp-yw575/GEC/NoiseGram/models/v003/eval-clc-test-beam-1/2_"+self.noise_configs['noise_type']+"_mul_"+str(self.noise_configs['weight'])
