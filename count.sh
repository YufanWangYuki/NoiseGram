...
output_file=results/adv/count_adv_single0.txt

base_path=/home/alta/BLTSpeaking/exp-yw575/GEC/NoiseGram/models/v001/eval-clc-test-beam-1/adv_updated/2_Gaussian-adversarial-single_mul_0.0/translate.txt
# for ntype in Gaussian-adversarial Adversarial
# do
for ntype in Adversarial-single
do
for weight in 1.0
do
